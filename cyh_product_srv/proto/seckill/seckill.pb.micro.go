...
type SecKillsService interface {
	...
	FrontSecKillList(ctx context.Context, in *FrontSecKillRequest, opts ...client.CallOption) (*SecKillsResponse, error)
...
func (c *secKillsService) FrontSecKillList(ctx context.Context, in *FrontSecKillRequest, opts ...client.CallOption) (*SecKillsResponse, error) {
...
type SecKillsHandler interface {
	...
	FrontSecKillList(context.Context, *FrontSecKillRequest, *SecKillsResponse) error
...
func RegisterSecKillsHandler(s server.Server, hdlr SecKillsHandler, opts ...server.HandlerOption) error {
	type secKills interface {
		...
		FrontSecKillList(ctx context.Context, in *FrontSecKillRequest, out *SecKillsResponse) error
...
func (h *secKillsHandler) FrontSecKillList(ctx context.Context, in *FrontSecKillRequest, out *SecKillsResponse) error {
