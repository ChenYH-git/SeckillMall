...
type ProductsService interface {
	...
	ProductDel(ctx context.Context, in *ProductDelRequest, opts ...client.CallOption) (*ProductDelResponse, error)
...
func (c *productsService) ProductDel(ctx context.Context, in *ProductDelRequest, opts ...client.CallOption) (*ProductDelResponse, error) {
	req := c.c.NewRequest(c.name, "Products.ProductDel", in)
	out := new(ProductDelResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ProductsHandler interface {
	...
	ProductDel(context.Context, *ProductDelRequest, *ProductDelResponse) error
...
func RegisterProductsHandler(s server.Server, hdlr ProductsHandler, opts ...server.HandlerOption) error {
	type products interface {
		...
		ProductDel(ctx context.Context, in *ProductDelRequest, out *ProductDelResponse) error
...
func (h *productsHandler) ProductDel(ctx context.Context, in *ProductDelRequest, out *ProductDelResponse) error {
